...
- Lightweight integer literal obfuscation via `obfuscate_num!($n)`
...
- Optional `secure_zeroize` feature to zeroize supported clear values generated by `#[derive(Obfuscate)]`
